...
def fig_sar_kspace(out):
    """PFA in three states, after Doerry ('Basics of Polar Format algorithm for processing SAR
    images'), Figures 3 and 5.

    The SAME uniform lattice is drawn behind all three panels: it is the grid the 2-D FFT requires.
    Panel 3's samples land exactly ON the intersections; panels 1 and 2 do not, and closing that
    gap is what the two interpolations do. Panels share one drawing box so they compare directly.

    Fig 3 -- polar grid of phase-history sample locations in the scene's Fourier space.
    Fig 5 -- after the FIRST (radial) interpolation the grid is TRAPEZOIDAL: p24 states k_y is then
             independent of azimuth index n, so rows are 'lined-up' (they sit on the grid rows),
             while k_x still carries an angular increment, so columns still miss."""
    d = Diagram(1180, 560, "PFA: polar -> radial interpolation -> azimuth interpolation",
                draw_title=False)
    d.note("t", 24, 14, 1130, 46,
           "Grey lattice = the uniform grid the 2-D FFT REQUIRES, the same in all three panels. "
           "Interpolation exists to move\neach sample onto an intersection. Panel 3 is there; "
           "panels 1 and 2 are not, in different ways.", fs=12)

    d.note("l1",  70, 84, 320, 22, "1  POLAR  (Doerry Fig 3)", fs=13)
    d.note("l2", 490, 84, 320, 22, "2  TRAPEZOIDAL  (Doerry Fig 5)", fs=13)
    d.note("l3", 890, 84, 320, 22, "3  RECTANGULAR  -- on the grid", fs=13)
    d.box("ga_v0", 82.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v1", 106.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v2", 130.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v3", 154.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v4", 178.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v5", 202.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v6", 226.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v7", 250.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_v8", 274.0, 130.0, 1, 170.0, "", "mem")
    d.box("ga_h0", 82.0, 130.0, 192.0, 1, "", "mem")
    d.box("ga_h1", 82.0, 164.0, 192.0, 1, "", "mem")
    d.box("ga_h2", 82.0, 198.0, 192.0, 1, "", "mem")
    d.box("ga_h3", 82.0, 232.0, 192.0, 1, "", "mem")
    d.box("ga_h4", 82.0, 266.0, 192.0, 1, "", "mem")
    d.box("ga_h5", 82.0, 300.0, 192.0, 1, "", "mem")
    d.box("gb_v0", 502.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v1", 526.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v2", 550.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v3", 574.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v4", 598.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v5", 622.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v6", 646.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v7", 670.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_v8", 694.0, 130.0, 1, 170.0, "", "mem")
    d.box("gb_h0", 502.0, 130.0, 192.0, 1, "", "mem")
    d.box("gb_h1", 502.0, 164.0, 192.0, 1, "", "mem")
    d.box("gb_h2", 502.0, 198.0, 192.0, 1, "", "mem")
    d.box("gb_h3", 502.0, 232.0, 192.0, 1, "", "mem")
    d.box("gb_h4", 502.0, 266.0, 192.0, 1, "", "mem")
    d.box("gb_h5", 502.0, 300.0, 192.0, 1, "", "mem")
    d.box("gc_v0", 902.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v1", 926.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v2", 950.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v3", 974.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v4", 998.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v5", 1022.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v6", 1046.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v7", 1070.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_v8", 1094.0, 130.0, 1, 170.0, "", "mem")
    d.box("gc_h0", 902.0, 130.0, 192.0, 1, "", "mem")
    d.box("gc_h1", 902.0, 164.0, 192.0, 1, "", "mem")
    d.box("gc_h2", 902.0, 198.0, 192.0, 1, "", "mem")
    d.box("gc_h3", 902.0, 232.0, 192.0, 1, "", "mem")
    d.box("gc_h4", 902.0, 266.0, 192.0, 1, "", "mem")
    d.box("gc_h5", 902.0, 300.0, 192.0, 1, "", "mem")
    d.box("a0", 96.2, 303.4, 7, 7, "", "mem")
    d.box("a1", 115.6, 300.4, 7, 7, "", "mem")
    d.box("a2", 135.2, 298.2, 7, 7, "", "mem")
    d.box("a3", 154.8, 296.9, 7, 7, "", "mem")
    d.box("a4", 174.5, 296.5, 7, 7, "", "mem")
    d.box("a5", 194.2, 296.9, 7, 7, "", "mem")
    d.box("a6", 213.8, 298.2, 7, 7, "", "mem")
    d.box("a7", 233.4, 300.4, 7, 7, "", "mem")
    d.box("a8", 252.8, 303.4, 7, 7, "", "mem")
    d.box("a9", 90.2, 269.9, 7, 7, "", "mem")
    d.box("a10", 111.2, 266.7, 7, 7, "", "mem")
    d.box("a11", 132.2, 264.4, 7, 7, "", "mem")
    d.box("a12", 153.3, 263.0, 7, 7, "", "mem")
    d.box("a13", 174.5, 262.5, 7, 7, "", "mem")
    d.box("a14", 195.7, 263.0, 7, 7, "", "mem")
    d.box("a15", 216.8, 264.4, 7, 7, "", "mem")
    d.box("a16", 237.8, 266.7, 7, 7, "", "mem")
    d.box("a17", 258.8, 269.9, 7, 7, "", "mem")
    d.box("a18", 84.3, 236.4, 7, 7, "", "mem")
    d.box("a19", 106.7, 233.0, 7, 7, "", "mem")
    d.box("a20", 129.2, 230.5, 7, 7, "", "mem")
    d.box("a21", 151.8, 229.0, 7, 7, "", "mem")
    d.box("a22", 174.5, 228.5, 7, 7, "", "mem")
    d.box("a23", 197.2, 229.0, 7, 7, "", "mem")
    d.box("a24", 219.8, 230.5, 7, 7, "", "mem")
    d.box("a25", 242.3, 233.0, 7, 7, "", "mem")
    d.box("a26", 264.7, 236.4, 7, 7, "", "mem")
    d.box("a27", 78.4, 202.9, 7, 7, "", "mem")
    d.box("a28", 102.3, 199.2, 7, 7, "", "mem")
    d.box("a29", 126.3, 196.6, 7, 7, "", "mem")
    d.box("a30", 150.4, 195.0, 7, 7, "", "mem")
    d.box("a31", 174.5, 194.5, 7, 7, "", "mem")
    d.box("a32", 198.6, 195.0, 7, 7, "", "mem")
    d.box("a33", 222.7, 196.6, 7, 7, "", "mem")
    d.box("a34", 246.7, 199.2, 7, 7, "", "mem")
    d.box("a35", 270.6, 202.9, 7, 7, "", "mem")
    d.box("a36", 72.5, 169.5, 7, 7, "", "mem")
    d.box("a37", 97.8, 165.5, 7, 7, "", "mem")
    d.box("a38", 123.3, 162.7, 7, 7, "", "mem")
    d.box("a39", 148.9, 161.1, 7, 7, "", "mem")
    d.box("a40", 174.5, 160.5, 7, 7, "", "mem")
    d.box("a41", 200.1, 161.1, 7, 7, "", "mem")
    d.box("a42", 225.7, 162.7, 7, 7, "", "mem")
    d.box("a43", 251.2, 165.5, 7, 7, "", "mem")
    d.box("a44", 276.5, 169.5, 7, 7, "", "mem")
    d.box("a45", 66.6, 136.0, 7, 7, "", "mem")
    d.box("a46", 93.4, 131.8, 7, 7, "", "mem")
    d.box("a47", 120.3, 128.9, 7, 7, "", "mem")
    d.box("a48", 147.4, 127.1, 7, 7, "", "mem")
    d.box("a49", 174.5, 126.5, 7, 7, "", "mem")
    d.box("a50", 201.6, 127.1, 7, 7, "", "mem")
    d.box("a51", 228.7, 128.9, 7, 7, "", "mem")
    d.box("a52", 255.6, 131.8, 7, 7, "", "mem")
    d.box("a53", 282.4, 136.0, 7, 7, "", "mem")
    d.box("b0", 535.0, 296.5, 7, 7, "", "fab")
    d.box("b1", 549.9, 296.5, 7, 7, "", "fab")
    d.box("b2", 564.7, 296.5, 7, 7, "", "fab")
    d.box("b3", 579.6, 296.5, 7, 7, "", "fab")
    d.box("b4", 594.5, 296.5, 7, 7, "", "fab")
    d.box("b5", 609.4, 296.5, 7, 7, "", "fab")
    d.box("b6", 624.3, 296.5, 7, 7, "", "fab")
    d.box("b7", 639.1, 296.5, 7, 7, "", "fab")
    d.box("b8", 654.0, 296.5, 7, 7, "", "fab")
    d.box("b9", 527.7, 262.5, 7, 7, "", "fab")
    d.box("b10", 544.4, 262.5, 7, 7, "", "fab")
    d.box("b11", 561.1, 262.5, 7, 7, "", "fab")
    d.box("b12", 577.8, 262.5, 7, 7, "", "fab")
    d.box("b13", 594.5, 262.5, 7, 7, "", "fab")
    d.box("b14", 611.2, 262.5, 7, 7, "", "fab")
    d.box("b15", 627.9, 262.5, 7, 7, "", "fab")
    d.box("b16", 644.6, 262.5, 7, 7, "", "fab")
    d.box("b17", 661.3, 262.5, 7, 7, "", "fab")
    d.box("b18", 520.4, 228.5, 7, 7, "", "fab")
    d.box("b19", 538.9, 228.5, 7, 7, "", "fab")
    d.box("b20", 557.4, 228.5, 7, 7, "", "fab")
    d.box("b21", 576.0, 228.5, 7, 7, "", "fab")
    d.box("b22", 594.5, 228.5, 7, 7, "", "fab")
    d.box("b23", 613.0, 228.5, 7, 7, "", "fab")
    d.box("b24", 631.6, 228.5, 7, 7, "", "fab")
    d.box("b25", 650.1, 228.5, 7, 7, "", "fab")
    d.box("b26", 668.6, 228.5, 7, 7, "", "fab")
    d.box("b27", 513.1, 194.5, 7, 7, "", "fab")
    d.box("b28", 533.4, 194.5, 7, 7, "", "fab")
    d.box("b29", 553.8, 194.5, 7, 7, "", "fab")
    d.box("b30", 574.1, 194.5, 7, 7, "", "fab")
    d.box("b31", 594.5, 194.5, 7, 7, "", "fab")
    d.box("b32", 614.9, 194.5, 7, 7, "", "fab")
    d.box("b33", 635.2, 194.5, 7, 7, "", "fab")
    d.box("b34", 655.6, 194.5, 7, 7, "", "fab")
    d.box("b35", 675.9, 194.5, 7, 7, "", "fab")
    d.box("b36", 505.8, 160.5, 7, 7, "", "fab")
    d.box("b37", 528.0, 160.5, 7, 7, "", "fab")
    d.box("b38", 550.1, 160.5, 7, 7, "", "fab")
    d.box("b39", 572.3, 160.5, 7, 7, "", "fab")
    d.box("b40", 594.5, 160.5, 7, 7, "", "fab")
    d.box("b41", 616.7, 160.5, 7, 7, "", "fab")
    d.box("b42", 638.9, 160.5, 7, 7, "", "fab")
    d.box("b43", 661.0, 160.5, 7, 7, "", "fab")
    d.box("b44", 683.2, 160.5, 7, 7, "", "fab")
    d.box("b45", 498.5, 126.5, 7, 7, "", "fab")
    d.box("b46", 522.5, 126.5, 7, 7, "", "fab")
    d.box("b47", 546.5, 126.5, 7, 7, "", "fab")
    d.box("b48", 570.5, 126.5, 7, 7, "", "fab")
    d.box("b49", 594.5, 126.5, 7, 7, "", "fab")
    d.box("b50", 618.5, 126.5, 7, 7, "", "fab")
    d.box("b51", 642.5, 126.5, 7, 7, "", "fab")
    d.box("b52", 666.5, 126.5, 7, 7, "", "fab")
    d.box("b53", 690.5, 126.5, 7, 7, "", "fab")
    d.box("c0", 898.5, 126.5, 7, 7, "", "ip")
    d.box("c1", 922.5, 126.5, 7, 7, "", "ip")
    d.box("c2", 946.5, 126.5, 7, 7, "", "ip")
    d.box("c3", 970.5, 126.5, 7, 7, "", "ip")
    d.box("c4", 994.5, 126.5, 7, 7, "", "ip")
    d.box("c5", 1018.5, 126.5, 7, 7, "", "ip")
    d.box("c6", 1042.5, 126.5, 7, 7, "", "ip")
    d.box("c7", 1066.5, 126.5, 7, 7, "", "ip")
    d.box("c8", 1090.5, 126.5, 7, 7, "", "ip")
    d.box("c9", 898.5, 160.5, 7, 7, "", "ip")
    d.box("c10", 922.5, 160.5, 7, 7, "", "ip")
    d.box("c11", 946.5, 160.5, 7, 7, "", "ip")
    d.box("c12", 970.5, 160.5, 7, 7, "", "ip")
    d.box("c13", 994.5, 160.5, 7, 7, "", "ip")
    d.box("c14", 1018.5, 160.5, 7, 7, "", "ip")
    d.box("c15", 1042.5, 160.5, 7, 7, "", "ip")
    d.box("c16", 1066.5, 160.5, 7, 7, "", "ip")
    d.box("c17", 1090.5, 160.5, 7, 7, "", "ip")
    d.box("c18", 898.5, 194.5, 7, 7, "", "ip")
    d.box("c19", 922.5, 194.5, 7, 7, "", "ip")
    d.box("c20", 946.5, 194.5, 7, 7, "", "ip")
    d.box("c21", 970.5, 194.5, 7, 7, "", "ip")
    d.box("c22", 994.5, 194.5, 7, 7, "", "ip")
    d.box("c23", 1018.5, 194.5, 7, 7, "", "ip")
    d.box("c24", 1042.5, 194.5, 7, 7, "", "ip")
    d.box("c25", 1066.5, 194.5, 7, 7, "", "ip")
    d.box("c26", 1090.5, 194.5, 7, 7, "", "ip")
    d.box("c27", 898.5, 228.5, 7, 7, "", "ip")
    d.box("c28", 922.5, 228.5, 7, 7, "", "ip")
    d.box("c29", 946.5, 228.5, 7, 7, "", "ip")
    d.box("c30", 970.5, 228.5, 7, 7, "", "ip")
    d.box("c31", 994.5, 228.5, 7, 7, "", "ip")
    d.box("c32", 1018.5, 228.5, 7, 7, "", "ip")
    d.box("c33", 1042.5, 228.5, 7, 7, "", "ip")
    d.box("c34", 1066.5, 228.5, 7, 7, "", "ip")
    d.box("c35", 1090.5, 228.5, 7, 7, "", "ip")
    d.box("c36", 898.5, 262.5, 7, 7, "", "ip")
    d.box("c37", 922.5, 262.5, 7, 7, "", "ip")
    d.box("c38", 946.5, 262.5, 7, 7, "", "ip")
    d.box("c39", 970.5, 262.5, 7, 7, "", "ip")
    d.box("c40", 994.5, 262.5, 7, 7, "", "ip")
    d.box("c41", 1018.5, 262.5, 7, 7, "", "ip")
    d.box("c42", 1042.5, 262.5, 7, 7, "", "ip")
    d.box("c43", 1066.5, 262.5, 7, 7, "", "ip")
    d.box("c44", 1090.5, 262.5, 7, 7, "", "ip")
    d.box("c45", 898.5, 296.5, 7, 7, "", "ip")
    d.box("c46", 922.5, 296.5, 7, 7, "", "ip")
    d.box("c47", 946.5, 296.5, 7, 7, "", "ip")
    d.box("c48", 970.5, 296.5, 7, 7, "", "ip")
    d.box("c49", 994.5, 296.5, 7, 7, "", "ip")
    d.box("c50", 1018.5, 296.5, 7, 7, "", "ip")
