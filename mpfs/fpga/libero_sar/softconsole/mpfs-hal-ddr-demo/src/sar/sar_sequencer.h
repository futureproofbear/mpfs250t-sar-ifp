...
/* H4 concurrency micro-benchmark: times corner-turn alone / FFT alone / both concurrent
 * to a JTAG-readable record @0xB005E400. Firmware-only; decides FIC_0 overlap-vs-serialize. */
