...
*/
#define LIBERO_SETTING_ALT_IOMUX0_CR    0x00000080UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX3_CR    0xFFFFFFFFUL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX4_CR    0xFFFFFFFFUL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX5_CR    0xFFFFFFFFUL
...
IOMUX structure */
#define LIBERO_SETTING_ALT_IOMUX6_CR    0x0000001DUL
