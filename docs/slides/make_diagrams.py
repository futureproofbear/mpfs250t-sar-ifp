...
def fig_sar_kspace(out):
    """PFA in three states, following Doerry (Sandia SAND2012-xxxx, 'Basics of Polar Format
    algorithm for processing SAR images'), Figures 3 and 5.

    Fig 3 -- polar grid of phase-history sample locations in the scene's Fourier space.
    Fig 5 -- after the FIRST (radial) interpolation the grid is TRAPEZOIDAL: p24 states that k_y is
             then independent of azimuth index n, so rows are 'lined-up', while k_x still carries
             an angular increment. Rows align; x spacing within a row scales with its radius.
    Drawn from that description; sample POSITIONS carry it, so no arc primitive is needed."""
    d = Diagram(1180, 560, "PFA: polar collection -> radial interpolation -> azimuth interpolation",
                draw_title=False)
    d.note("t", 24, 16, 1130, 46,
           "The collection samples the scene's Fourier space on a POLAR grid; the 2-D FFT needs a "
           "uniform RECTANGULAR one.\nPFA gets there in TWO interpolations, and the middle state "
           "is why there must be two.", fs=12)

    d.note("l1",  70, 82, 320, 22, "1  POLAR  (Doerry Fig 3)", fs=13)
    d.note("l2", 500, 82, 320, 22, "2  TRAPEZOIDAL  (Doerry Fig 5)", fs=13)
    d.note("l3", 830, 82, 320, 22, "3  RECTANGULAR", fs=13)
    ...
    d.box("b0", 531.2, 288.0, 7, 7, "", "fab")
    d.box("b1", 550.9, 288.0, 7, 7, "", "fab")
    d.box("b2", 570.6, 288.0, 7, 7, "", "fab")
    d.box("b3", 590.3, 288.0, 7, 7, "", "fab")
    d.box("b4", 610.0, 288.0, 7, 7, "", "fab")
    d.box("b5", 629.7, 288.0, 7, 7, "", "fab")
    d.box("b6", 649.4, 288.0, 7, 7, "", "fab")
    d.box("b7", 669.1, 288.0, 7, 7, "", "fab")
    d.box("b8", 688.8, 288.0, 7, 7, "", "fab")
    d.box("b9", 526.0, 254.0, 7, 7, "", "fab")
    d.box("b10", 547.0, 254.0, 7, 7, "", "fab")
    d.box("b11", 568.0, 254.0, 7, 7, "", "fab")
    d.box("b12", 589.0, 254.0, 7, 7, "", "fab")
    d.box("b13", 610.0, 254.0, 7, 7, "", "fab")
    d.box("b14", 631.0, 254.0, 7, 7, "", "fab")
    d.box("b15", 652.0, 254.0, 7, 7, "", "fab")
    d.box("b16", 673.0, 254.0, 7, 7, "", "fab")
    d.box("b17", 694.0, 254.0, 7, 7, "", "fab")
    d.box("b18", 520.8, 220.0, 7, 7, "", "fab")
    d.box("b19", 543.1, 220.0, 7, 7, "", "fab")
    d.box("b20", 565.4, 220.0, 7, 7, "", "fab")
    d.box("b21", 587.7, 220.0, 7, 7, "", "fab")
    d.box("b22", 610.0, 220.0, 7, 7, "", "fab")
    d.box("b23", 632.3, 220.0, 7, 7, "", "fab")
    d.box("b24", 654.6, 220.0, 7, 7, "", "fab")
    d.box("b25", 676.9, 220.0, 7, 7, "", "fab")
    d.box("b26", 699.2, 220.0, 7, 7, "", "fab")
    d.box("b27", 515.5, 186.0, 7, 7, "", "fab")
    d.box("b28", 539.1, 186.0, 7, 7, "", "fab")
    d.box("b29", 562.8, 186.0, 7, 7, "", "fab")
    d.box("b30", 586.4, 186.0, 7, 7, "", "fab")
    d.box("b31", 610.0, 186.0, 7, 7, "", "fab")
    d.box("b32", 633.6, 186.0, 7, 7, "", "fab")
    d.box("b33", 657.2, 186.0, 7, 7, "", "fab")
    d.box("b34", 680.9, 186.0, 7, 7, "", "fab")
    d.box("b35", 704.5, 186.0, 7, 7, "", "fab")
    d.box("b36", 510.2, 152.0, 7, 7, "", "fab")
    d.box("b37", 535.2, 152.0, 7, 7, "", "fab")
    d.box("b38", 560.1, 152.0, 7, 7, "", "fab")
    d.box("b39", 585.1, 152.0, 7, 7, "", "fab")
    d.box("b40", 610.0, 152.0, 7, 7, "", "fab")
    d.box("b41", 634.9, 152.0, 7, 7, "", "fab")
    d.box("b42", 659.9, 152.0, 7, 7, "", "fab")
    d.box("b43", 684.8, 152.0, 7, 7, "", "fab")
    d.box("b44", 709.8, 152.0, 7, 7, "", "fab")
    d.box("b45", 505.0, 118.0, 7, 7, "", "fab")
    d.box("b46", 531.2, 118.0, 7, 7, "", "fab")
    d.box("b47", 557.5, 118.0, 7, 7, "", "fab")
    d.box("b48", 583.8, 118.0, 7, 7, "", "fab")
    d.box("b49", 610.0, 118.0, 7, 7, "", "fab")
    d.box("b50", 636.2, 118.0, 7, 7, "", "fab")
    d.box("b51", 662.5, 118.0, 7, 7, "", "fab")
    d.box("b52", 688.8, 118.0, 7, 7, "", "fab")
    d.box("b53", 715.0, 118.0, 7, 7, "", "fab")
    d.box("c0", 784.0, 118.0, 7, 7, "", "ip")
    d.box("c1", 808.0, 118.0, 7, 7, "", "ip")
    d.box("c2", 832.0, 118.0, 7, 7, "", "ip")
    d.box("c3", 856.0, 118.0, 7, 7, "", "ip")
    d.box("c4", 880.0, 118.0, 7, 7, "", "ip")
    d.box("c5", 904.0, 118.0, 7, 7, "", "ip")
    d.box("c6", 928.0, 118.0, 7, 7, "", "ip")
    d.box("c7", 952.0, 118.0, 7, 7, "", "ip")
    d.box("c8", 976.0, 118.0, 7, 7, "", "ip")
    d.box("c9", 784.0, 152.0, 7, 7, "", "ip")
    d.box("c10", 808.0, 152.0, 7, 7, "", "ip")
    d.box("c11", 832.0, 152.0, 7, 7, "", "ip")
    d.box("c12", 856.0, 152.0, 7, 7, "", "ip")
    d.box("c13", 880.0, 152.0, 7, 7, "", "ip")
    d.box("c14", 904.0, 152.0, 7, 7, "", "ip")
    d.box("c15", 928.0, 152.0, 7, 7, "", "ip")
    d.box("c16", 952.0, 152.0, 7, 7, "", "ip")
    d.box("c17", 976.0, 152.0, 7, 7, "", "ip")
    d.box("c18", 784.0, 186.0, 7, 7, "", "ip")
    d.box("c19", 808.0, 186.0, 7, 7, "", "ip")
    d.box("c20", 832.0, 186.0, 7, 7, "", "ip")
    d.box("c21", 856.0, 186.0, 7, 7, "", "ip")
    d.box("c22", 880.0, 186.0, 7, 7, "", "ip")
    d.box("c23", 904.0, 186.0, 7, 7, "", "ip")
    d.box("c24", 928.0, 186.0, 7, 7, "", "ip")
    d.box("c25", 952.0, 186.0, 7, 7, "", "ip")
    d.box("c26", 976.0, 186.0, 7, 7, "", "ip")
    d.box("c27", 784.0, 220.0, 7, 7, "", "ip")
    d.box("c28", 808.0, 220.0, 7, 7, "", "ip")
    d.box("c29", 832.0, 220.0, 7, 7, "", "ip")
    d.box("c30", 856.0, 220.0, 7, 7, "", "ip")
    d.box("c31", 880.0, 220.0, 7, 7, "", "ip")
    d.box("c32", 904.0, 220.0, 7, 7, "", "ip")
    d.box("c33", 928.0, 220.0, 7, 7, "", "ip")
    d.box("c34", 952.0, 220.0, 7, 7, "", "ip")
    d.box("c35", 976.0, 220.0, 7, 7, "", "ip")
    d.box("c36", 784.0, 254.0, 7, 7, "", "ip")
    d.box("c37", 808.0, 254.0, 7, 7, "", "ip")
    d.box("c38", 832.0, 254.0, 7, 7, "", "ip")
    d.box("c39", 856.0, 254.0, 7, 7, "", "ip")
    d.box("c40", 880.0, 254.0, 7, 7, "", "ip")
    d.box("c41", 904.0, 254.0, 7, 7, "", "ip")
    d.box("c42", 928.0, 254.0, 7, 7, "", "ip")
    d.box("c43", 952.0, 254.0, 7, 7, "", "ip")
    d.box("c44", 976.0, 254.0, 7, 7, "", "ip")
    d.box("c45", 784.0, 288.0, 7, 7, "", "ip")
    d.box("c46", 808.0, 288.0, 7, 7, "", "ip")
    d.box("c47", 832.0, 288.0, 7, 7, "", "ip")
    d.box("c48", 856.0, 288.0, 7, 7, "", "ip")
    d.box("c49", 880.0, 288.0, 7, 7, "", "ip")
    d.box("c50", 904.0, 288.0, 7, 7, "", "ip")
    d.box("c51", 928.0, 288.0, 7, 7, "", "ip")
    d.box("c52", 952.0, 288.0, 7, 7, "", "ip")
    d.box("c53", 976.0, 288.0, 7, 7, "", "ip")
    d.note("m1", 34, 300, 360, 100,
           "k_r[i,n] = (2/c)(f0 + i dF) per pulse n\n\n"
           "Each pulse is an arc at its own aspect angle;\ni steps outward in range frequency. "
           "Neither\nk_x nor k_y is uniform, so no FFT applies.", fs=11)
    d.note("m2", 430, 330, 380, 100,
           "RADIAL interpolate so k_y(i',n) = k_y(i')\n"
           "    T_s i' = T_s i cos(theta_n)\n\n"
           "k_y is now independent of azimuth index -- rows\nare LINED UP. But k_x still carries "
           "an angular\nincrement, so the grid is a TRAPEZOID, not a\nrectangle. Hence a second "
           "interpolation.", fs=11)
    d.note("m3", 830, 330, 320, 100,
           "AZIMUTH interpolate so k_x(i',n') = k_x(n')\n"
           "    T_s i' d_n tan(theta_n) = d_n'\n\n"
           "Uniform in BOTH axes: a separable 2-D FFT\napplies, so the hardware runs two 1-D "
           "passes\nwith a transpose -- the corner-turn -- between.", fs=11)
