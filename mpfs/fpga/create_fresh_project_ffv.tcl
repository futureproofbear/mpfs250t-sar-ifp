...
## sar_coeffgen: on-fabric azimuth resample coefficients, NEW 8th CIC target @0x60007000. No AXI4
## initiator -> no DIC port; its output is a plain {idx,wq} stream into FEED. Hand-written Verilog.
source "$here/sar_coeffgen_core.tcl"
build_design_hierarchy
