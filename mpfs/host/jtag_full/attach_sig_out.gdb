...
dump binary memory ../jtag_stage_small/sig_r896.bin 0x89C00000 (0x89C00000 + 0x100000)
echo >>> dump OUT rows 896..927 (32 rows, 512KB) -> out_r896.bin\n
dump binary memory ../jtag_stage_small/out_r896.bin 0xA8E00000 (0xA8E00000 + 0x80000)
echo >>> dumps done\n
monitor resume
monitor shutdown
quit
