...
LOG="/c/Users/lkwangsi/Tools/openocd-new/read_prof.log"
...
"$GDB" "$ELF" -x read_prof.gdb 2>&1 | tr -d '\r' | grep -avE '^Reading|warranty|GPL|free soft|GNU gdb|Copyright|documentation|bug report|configured as|^Type |sifive|For help|apropos'
