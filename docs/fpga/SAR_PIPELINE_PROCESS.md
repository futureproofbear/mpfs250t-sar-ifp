...
> end-to-end on silicon, image corr=0.9923 vs golden**, total **37.72 s** per frame (2026-07-24, 100 MHz, azimuth-gather + detect + corner-turn/FFT-2 overlap) with the scene
