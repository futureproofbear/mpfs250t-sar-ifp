...
Total 37.72 s (2026-07-24, 100 MHz, azimuth-gather + detect + corner-turn/FFT-2 overlap fused); the per-stage breakdown is in
...
| 5 | `PIPE` — run the pipeline (37.72 s) | Needs SIG and the geometry tables in DDR |
