...
CFG="C:/Users/lkwangsi/Documents/github/mpfs250t-sar-ifp/mpfs/fpga/efp6_test.cfg"
LOG="/c/Users/lkwangsi/Tools/openocd-new/test.log"
cmd /c "taskkill /F /IM openocd.exe" >/dev/null 2>&1
: > "$LOG"
rm -f /c/Users/lkwangsi/Documents/github/mpfs250t-sar-ifp/mpfs/host/jtag_full/out_1mb.bin
...
echo "=== out_1mb.bin ==="
ls -la /c/Users/lkwangsi/Documents/github/mpfs250t-sar-ifp/mpfs/host/jtag_full/out_1mb.bin 2>/dev/null | awk '{print $5}' || echo "none"
