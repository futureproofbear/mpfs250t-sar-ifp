...
(`fft_mode=1` confirmed at runtime, 40.91 s per frame (2026-07-23, azimuth-gather + detect + corner-turn/FFT-2 overlap), corr 0.9923 vs golden). The CPU FFT remains
