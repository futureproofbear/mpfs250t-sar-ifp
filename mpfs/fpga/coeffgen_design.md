...
| HLS | **none.** No SmartHLS involvement, no pragmas, no interface bundles. This is hand-written Verilog by mandate (`docs/SAR_IMPLEMENTATION_RECORD.md` Part 2, `docs/fpga/DEV_GUIDE.md` §1) |
