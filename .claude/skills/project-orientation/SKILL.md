...
- **Full autonomous on-board run (re-confirmed 2026-07-20):** scene loaded from the board's own eMMC
  (81.5 s, `sig_crc 0x89fa12dc` verified) → focused in **40.91 s** (2026-07-23, azimuth-gather + detect + corner-turn/FFT-2 overlap; `SAR_SEQ_OK`, `fft_mode=1` FABRIC
...
- Latency reduction (40.91 s, 2026-07-23). The FFT is already on fabric, and the targeted coefficient-bank CCACHE
